document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderFilters() {
    if (!jobTagsContainer) return;
    const tags = [...new Set(allJobs.flatMap(job => job.tags))].sort();
    let filterDiv = jobTagsContainer.querySelector("#job-tag-filters");
    if (!filterDiv) {
      filterDiv = document.createElement("div");
      filterDiv.id = "job-tag-filters";
      jobTagsContainer.appendChild(filterDiv);
    }
